...
NS_LOG_COMPONENT_DEFINE ("inrpp5");
...
//
  ...
  Ptr<InrppL3Protocol> ip = nodes.Get(0)->GetObject<InrppL3Protocol> (); //ip used later
/*Configure detour path at n0 SPFGetNextLink
...
//
  ...
  sinkApps.Stop (Seconds (100.0));
   ...
   sourceApps2.Start (Seconds (50.0));
   sourceApps2.Stop (Seconds (1000.0));
