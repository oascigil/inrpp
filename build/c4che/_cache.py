...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-Wall', '-Werror', '-Wno-potentially-evaluated-expression', '-Wno-unused-local-typedefs', '-Wno-deprecated-declarations', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-Wall', '-Werror', '-Wno-potentially-evaluated-expression', '-Wno-unused-local-typedefs', '-Wno-deprecated-declarations']
...
NS3_EXECUTABLE_PATH = ['/Users/srene/inrpp/build/src/fd-net-device']
...
NS3_MODULE_PATH = ['/Users/srene/inrpp/build']
...
VERSION = '3.23'
cfg_files = ['/Users/srene/inrpp/build/ns3/config-store-config.h', '/Users/srene/inrpp/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
