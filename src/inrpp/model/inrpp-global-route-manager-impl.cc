/* -*- Mode:C++; c-file-style:"gnu"; indent-tabs-mode:nil; -*- *e
...
#include "ns3/inrpp-global-route-manager-impl.h"
...
NS_LOG_COMPONENT_DEFINE ("InrppGlobalRouteManagerImpl");
...
/*
void //not sure if we need this (maybe to delete detour routes)
InrppGlobalRouteManagerImpl::DeleteGlobalRoutes ()
{
  NS_LOG_FUNCTION (this);
...
void
InrppGlobalRouteManagerImpl::InitializeRoutes ()
{
  NS_LOG_FUNCTION (this);
//
...
//
      if (rtr && rtr->GetNumLSAs () )
        {
          InrppSPFCalculate (rtr->GetRouterId ());
        }
    }
...
void
InrppGlobalRouteManagerImpl::InrppSPFNext (SPFVertex* v, CandidateQueue& candidate)
{
...
// In , the parent nodes, the next hops, and the root's
...
//
int
InrppGlobalRouteManagerImpl::SPFNexthopCalculation (
  SPFVertex* v, 
  SPFVertex* w,
...
void
InrppGlobalRouteManagerImpl::InrppSPFCalculate (Ipv4Address root)
{
  NS_LOG_FUNCTION (this << root);
